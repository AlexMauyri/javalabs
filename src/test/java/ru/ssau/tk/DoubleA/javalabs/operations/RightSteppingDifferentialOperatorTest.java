...
public class RightSteppingDifferentialOperatorTest extends AbstractTest {
    @Test
    void test() {
        double step = 1E-5;
        ...
        step = 1E-7;
        function = new RightSteppingDifferentialOperator(step);
        ...
        RightSteppingDifferentialOperator finalFunction = function;
