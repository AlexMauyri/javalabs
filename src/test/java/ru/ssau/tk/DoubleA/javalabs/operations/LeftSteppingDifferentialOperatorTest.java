...
public class LeftSteppingDifferentialOperatorTest extends AbstractTest {
    ...
    void test() {
        ...
        step = 1E-7;
        function = new LeftSteppingDifferentialOperator(step);
        ...
        LeftSteppingDifferentialOperator finalFunction = function;
