...
public class AndThenMethodTest extends AbstractTest {
    ...
    void test() {
        ...
        MathFunction mathFunction = new NRootCalculateFunction(5).andThen(
                    new SqrFunction().andThen(
                            new NRootCalculateFunction(3)
                    )
                );
        ...
        mathFunction = new SqrFunction().andThen(
                new ConstantFunction(243.24325).andThen(
        ...
        mathFunction = new NRootCalculateFunction(39).andThen(
                new SqrFunction().andThen(
